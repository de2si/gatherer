...
const UploadIcon = ({
  ...
  <Svg
    ...
    <Path
      fill={color}
      d="M12.553 2.494a.75.75 0 0 0-1.107 0l-4 4.375A.75.75 0 0 0 8.554 7.88l2.696-2.95V16a.75.75 0 0 0 1.5 0V4.932l2.697 2.95a.75.75 0 1 0 1.107-1.013l-4-4.375Z"
    />
    <Path
      fill={color}
